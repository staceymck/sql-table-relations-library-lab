CREATE TABLE series (id INTEGER PRIMARY KEY, title TEXT, author_id, subgenre_id);
...
CREATE TABLE characters (id INTEGER PRIMARY KEY, name TEXT, motto TEXT, species TEXT, author_id);
